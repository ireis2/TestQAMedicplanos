...
describe('TESTE FELIZ SOLICITAR CARTÃO PLANO BÁSICO', () => {   
    it('Preencher Cadastro e escolher Plano Básico', function ()  {
    ...
    it('Validar página, resumo do plano escolhido e escolher a forma de pagamento boleto', () => {
        ...
        cy.get('.register_resume__5VrQU p').should('have.text', "Resumo:Plano Básico R$ 32,00/mês")
